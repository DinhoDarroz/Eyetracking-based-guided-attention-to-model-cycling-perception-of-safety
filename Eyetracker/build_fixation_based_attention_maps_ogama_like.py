...
GLOBAL_OUT_DIR = "Eyetracker_attention_maps"
HEATMAP_RES = (14, 14)
MAX_COMPARISONS = 65
...
def main():
    ...
    # reuse user list
    #from build_global_attention_maps_users import USERS
    ...
    for survey_num, rel_path in enumerate(USERS, start=1):
        ...
        logging.info(f"[Survey {survey_num}] {survey_dir}")
        ...
        for _, row in comps.iterrows():
            ...
            for side in ['left', 'right']:
                ...
                # ---------- FULL RES OVERLAY ----------
                if not args.npy_only:
                    name_full = f"survey{survey_num}_trial{trial_id}_{stim}_{side}_FULLRES.png"
                ...
                name_npy = f"survey{survey_num}_trial{trial_id}_{stim}_{side}_eyetrack.npy"
                ...
                if not args.npy_only:
                    ...
                    name_png = f"survey{survey_num}_trial{trial_id}_{stim}_{side}_eyetrack.png"
                    save_14x14_overlay(
